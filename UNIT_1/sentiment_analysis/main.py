...
#-------------------------------------------------------------------------------
# Compare learning algoritms ( perceptron, average perceptron and pegasos)
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Training and validation accuracy for learning algoritms
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
#Maximum accuracy with the best method (Pegasos) along with the optimal 
#hyperparameters according to validation accuracies to test against the test
# dataset. The test data has been provided as test_bow_features and test_labels.
#-------------------------------------------------------------------------------
